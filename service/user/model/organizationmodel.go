...
func NewOrganizationModel(conn sqlx.SqlConn, c cache.CacheConf, opts ...cache.Option) OrganizationModel {
	return &customOrganizationModel{
		defaultOrganizationModel: newOrganizationModel(conn, c, opts...),
	}
}
